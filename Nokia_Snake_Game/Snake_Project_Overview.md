This is a replicate of the Nokia Snake Game.
...
4 Every time the snake eats food, its body length increases by one
5 The snake can move up, down, left, or right. When the snake moves up, it can not change direction to down. Vice versa. The same concept applies to left/right.
